...
We will now define the limits of our map and read in the detailed shape-file. This file can be downloaded from [gadm.org](http://www.gadm.org/country) and copied to the data folder.
